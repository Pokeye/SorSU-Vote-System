document.addEventListener('DOMContentLoaded', () => {
    ...
    const resultsData = [
        {
            position: "President",
            candidates: [
                { id: "chart-ssc-president-pia", name: "Pia Alonzo Wurtzbach", votes: 92, percentage: "92%", color: "#a90000" }
            ]
        },
        {
            position: "Vice President",
            candidates: [
                { id: "chart-ssc-vp-catriona", name: "Catriona Gray", votes: 85, percentage: "85%", color: "#a90000" }
            ]
        },
        {
            position: "Secretary General",
            candidates: [
                { id: "chart-ssc-secretary-hillary", name: "Hillary P. Clinton", votes: 55, percentage: "55%", color: "#ffc107" },
                { id: "chart-ssc-secretary-barack", name: "Barack H. Obama", votes: 45, percentage: "45%", color: "#ffc107" }
            ]
        },
        {
            position: "Treasurer",
            candidates: [
                { id: "chart-ssc-treasurer-queen", name: "Queen Elizabeth II", votes: 78, percentage: "78%", color: "#a90000" }
            ]
        },
        {
            position: "Auditor",
            candidates: [
                { id: "chart-ssc-auditor-king", name: "King Charles III", votes: 65, percentage: "65%", color: "#a90000" },
                { id: "chart-ssc-auditor-prince", name: "Prince William", votes: 35, percentage: "35%", color: "#a90000" }
            ]
        },
        {
            position: "Public Information Officer",
            candidates: [
                { id: "chart-ssc-pio-meghan", name: "Meghan Markle", votes: 100, percentage: "100%", color: "#a90000" }
            ]
        }
    ];
    ...
    (async () => {
        try {
            const res = await fetch(apiUrl('/api/results?electionId=ssc'), { credentials: 'include' });
            if (!res.ok) return;
